...
class Doctors {
  ...
  Doctors({this.userName, this.age, this.gender, this.contact, this.email, this.doctorverify, this.about, this.address, this.district, this.workingtime, this.qualification, this.profile, this.proof});
