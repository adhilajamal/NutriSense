...
class ChatScreenDoctorDetails extends StatefulWidget {
  const ChatScreenDoctorDetails({super.key});

  @override
  State<ChatScreenDoctorDetails> createState() => _ChatScreenDoctorDetailsState();
}

class _ChatScreenDoctorDetailsState extends State<ChatScreenDoctorDetails> {
  @override
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(onPressed: () {
              // Navigator.pushNamed(context, 'userchatscreen',arguments: ChatPageArguments(name: 'John Doe'),
              // );
            }, 
            ...
            child: Row(children: [
              Padding(
                ...
                child: Text('Ask doubts',style: TextStyle(fontSize: 16),),
              ),
              Padding(
